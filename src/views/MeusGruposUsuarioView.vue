      ...
      <div v-else class="groups-section stagger-in-2">
        <div class="profile-header">
          ...
          <div class="welcome-texts">
            <h1 class="welcome-title">Meus Grupos</h1>
            <p class="welcome-subtitle">Acompanhe os grupos dos quais você faz parte.</p>
          </div>
        </div>

        <div class="divider"></div>

        <h3 class="section-title">Grupos Vinculados</h3>
